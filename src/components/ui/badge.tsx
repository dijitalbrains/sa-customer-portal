type BadgeStatus = "active" | "paused" | "expired" | "pending" | "complete" | "scheduled";
...
export default function Badge({ status, label }: BadgeProps) {
  ...
  return (
    <span
      className={`inline-flex items-center justify-center px-3 py-1 rounded-pill text-[11px] font-semibold ${statusStyles[status]}`}
    >
      {displayLabel}
    </span>
  );
